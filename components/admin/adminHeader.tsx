export default function AdminHeader() {
    return (
        <header className="flex justify-between py-4 border-b border-zinc-200 dark:border-zinc-700">
            <div className="w-100">
                <h1 className="text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100">
                    Olympus Theatre
                </h1>
                <h2 className="text-center text-zinc-600 dark:text-zinc-400">
                    Manager
                </h2>
            </div>
            <div className="w-100 flex items-center justify-center">
                <span className="mr-4 text-zinc-900 dark:text-zinc-100">
                    FirstName Lastname
                </span>
                <div className="w-8 h-8">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-zinc-900 dark:fill-zinc-100">
                        <g data-name="Layer 2">
                            <g data-name="log-out">
